...
% \input{testing}
 ...
 \includepdf[pages={1-13}]{manuals/proger_manual.pdf}
 
 \clearpage
 \addcontentsline{toc}{section}{11~~~~~Руководство пользователя}
 \includepdf[pages={1-10}]{manuals/user_manual.pdf}

\clearpage
\ESKDthisStyle{empty}
\addcontentsline{toc}{section}{12~~~~~Технико-экономическое обоснование дипломной работы}
\addcontentsline{toc}{subsection}{12.1~~Обоснование актуальности дипломной работы}
\addcontentsline{toc}{subsection}{12.2~~Организация и планирование работы}
